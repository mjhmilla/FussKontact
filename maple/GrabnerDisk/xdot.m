function pXdotreturn = pXdot(N, t, vX_in, XDOT)
  ...
  v2Contact11(2) = 0.0e0;
  v2Contact11(3) = 0.0e0;
  zz(32) = GrabnerDiskContact(r1Contact11, r2Contact11, v1Contact11, v2Contact11, R1Contact11, R2Contact11, w1Contact11, w2Contact11, CParamsContact11, CFContact11);
  zz(33) = CFContact11(1);
  zz(34) = CFContact11(2);
  zz(35) = CFContact11(3);
  zz(36) = CFContact11(4);
