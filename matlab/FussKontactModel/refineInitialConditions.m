...
errCFcn = @(x)calcContactForceError(x, ic, vParams, vToe, expGRF(1,:));

options = optimset('Display','off','Diagnostics','off','TolX',1e-8);
[zDelta fzErrSq] = fminunc(errCFcn,0, options);
ic(10) = ic(10) + zDelta;
